    ...
    return (
        <div className="AboutContainer">
            ...
            <div className="About">After getting my degree in Electrical Engineering,
             ...
             my journey towards becoming a software developer! I have learned a lot really enjoyed
             the projects that I have gotten to work on. I look forward to continuing my learning and 
             getting a job in tech!</div>
        </div>
    );
};
